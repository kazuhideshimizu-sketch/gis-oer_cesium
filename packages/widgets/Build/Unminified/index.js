...
Object.defineProperties(SceneModePickerViewModel.prototype, {
  ...
  duration: {
    ...
    set: function(value) {
      if (value < 0) {
        throw new DeveloperError20("duration value must be positive.");
      }
      this._duration = value;
    }
  },
...
function SelectionIndicatorViewModel(scene, selectionIndicatorElement, container) {
  ...
  if (!defined28(selectionIndicatorElement)) {
    throw new DeveloperError22("selectionIndicatorElement is required.");
  }
  if (!defined28(container)) {
  ...
  knockout_default.defineProperty(this, "isVisible", {
    get: function() {
      return this.showSelection && defined28(this.position);
    }
  });
...
SelectionIndicatorViewModel.prototype.update = function() {
  if (this.showSelection && defined28(this.position)) {
    const screenPosition = this.computeScreenSpacePosition(
      this.position,
      screenSpacePos
    );
    if (!defined28(screenPosition)) {
      this._screenPositionX = offScreen;
      this._screenPositionY = offScreen;
    } else {
      const container = this._container;
...
function ProjectionPickerViewModel(scene) {
  ...
  this._toggleDropDown = createCommand_default(function() {
    if (that.sceneMode === SceneMode2.SCENE2D || that._flightInProgress) {
      return;
    }
    that.dropDownVisible = !that.dropDownVisible;
  });
  ...
  this._eventHelper.add(
    ...
    function(transitioner, oldMode, newMode, isMorphing) {
      that.sceneMode = newMode;
      that._orthographic = newMode === SceneMode2.SCENE2D || that._scene.camera.frustum instanceof OrthographicFrustum;
    }
  );
  this._eventHelper.add(scene.preRender, function() {
    that._flightInProgress = defined30(scene.camera._currentFlight);
  });
  this._switchToPerspective = createCommand_default(function() {
    if (that.sceneMode === SceneMode2.SCENE2D) {
      return;
    }
